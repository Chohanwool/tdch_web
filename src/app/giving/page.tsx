...
export default function GivingPage() {
  return (
    <div className="mx-auto max-w-5xl space-y-8 px-6 pb-20 pt-12">
      ...
      <section className="rounded-2xl border border-cedar/10 bg-white/80 p-6 text-sm text-ink/80">
      ...
      <section className="rounded-2xl border border-cedar/10 bg-white/70 p-6 text-sm text-ink/75">
