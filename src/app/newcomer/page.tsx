    ...
    <div className="mx-auto max-w-5xl space-y-8 px-6 pb-20 pt-12">
      ...
      <ol className="grid gap-4 sm:grid-cols-2">
        {newcomerSteps.map((step, idx) => (
          <li key={step} className="rounded-2xl border border-cedar/10 bg-white/80 p-6">
      ...
      <section className="rounded-2xl border border-clay/25 bg-clay/5 p-6 text-sm text-ink/80">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="mt-4 inline-flex rounded-full bg-clay px-4 py-2 text-sm font-semibold text-ivory transition hover:bg-cedar"
        >
          카카오톡으로 문의
        </a>
      </section>
